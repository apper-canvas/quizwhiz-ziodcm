  ...
  return (
    <div className="min-h-screen bg-surface-50 dark:bg-surface-900 text-surface-800 dark:text-surface-100 transition-colors duration-300">
      ...
      <footer className="border-t border-surface-200 dark:border-surface-700 mt-12">
        <div className="container mx-auto px-4 py-6 text-center text-surface-500 dark:text-surface-400 text-sm">
          © {new Date().getFullYear()} QuizWhiz. Test your knowledge with interactive quizzes.
        </div>
      </footer>
